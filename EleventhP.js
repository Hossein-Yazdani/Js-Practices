...
while(isNaN(userNum1)){
    alert("استفاده از حروف مجاز نمیباشد لطفا مجدد امتحان کنید");
    userNum1 = +prompt("لطفا عدد اول را وارد کنید");
}
var userNum2 = +prompt("لطفا عدد دوم را وارد کنید");
while(isNaN(userNum2)){
    alert("استفاده از حروف مجاز نمیباشد لطفا مجدد امتحان کنید");
    userNum2 = +prompt("لطفا عدد دوم را وارد کنید");
}
var userNum3 = +prompt("لطفا عدد سوم را وارد کنید");
while(isNaN(userNum3)){
    alert("استفاده از حروف مجاز نمیباشد لطفا مجدد امتحان کنید");
    userNum3 = +prompt("لطفا عدد سوم را وارد کنید");
}
